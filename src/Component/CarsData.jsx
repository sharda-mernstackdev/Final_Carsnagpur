...
//       <h1>Car Details</h1>
//       <p><strong>Car Name:</strong> {data.carName || "Not available"}</p>
//       <p><strong>Brand:</strong> {data.brand || "Not available"}</p>
//       <p><strong>Kilometers Driven:</strong> {data.kilometer || "Not available"}</p>
//       <p><strong>Fuel Type:</strong> {data.petrol ? "Petrol" : data.diesel ? "Diesel" : "Other"}</p>
//       <p><strong>Owner:</strong> {data.owner || "Not available"}</p>
//       <p><strong>Price:</strong> ₹{data.price?.toLocaleString() || "Not available"}</p>
//       <p><strong>Date Added:</strong> {new Date(data.createdAt).toLocaleDateString() || "Not available"}</p>
          ...
          <div className="md:w-1/2 p-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center space-x-4">
                <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-full transition-colors duration-300 flex-grow">
                  Book Test Drive
                </button>
                <button
